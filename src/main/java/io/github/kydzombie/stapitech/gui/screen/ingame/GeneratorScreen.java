...
public class GeneratorScreen extends HandledScreen {
    ...
    public GeneratorScreen(PlayerEntity player, GeneratorBlockEntity generatorBlockEntity) {
        super(new GeneratorScreenHandler(player, generatorBlockEntity));
    ...
    protected void drawForeground() {
        textRenderer.draw("Generator", 89 - textRenderer.getWidth("Generator") / 2, 6, 0x404040);
        textRenderer.draw("Inventory", 8, backgroundHeight - 96 + 2, 0x404040);
    }

    @Override
    protected void drawBackground(float tickDelta) {
        int textureId = minecraft.textureManager.getTextureId("assets/stapitech/gui/generator.png");
